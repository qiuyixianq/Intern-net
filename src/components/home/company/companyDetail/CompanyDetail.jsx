...
export const CompanyDetail = () => {
    ...
    const renderApplyButton = (company, job) => {
        ...
        return (
            <a
                role="button"
                className="ms-2 badge rounded-pill bg-info text-dark text-decoration-none"
                href={`mailto:0125416@kdu-oneline.com?subject=Internship Application
                &body=Dear ${company.companyName}, I would like to apply for ${job.title} (Your Content)`}
            >
                Apply
            </a>
        )
                                ...
                                <div className="jobCard" key={index}>
                                    <div className="d-flex align-items-baseline justify-content-between">
                                        <div className="d-flex align-items-baseline">
                                            ...
                                            {renderApplyButton(selectedCompany, job)}
                                        </div>
